...
const projects: Project[] = [
  {
    ...
    title: 'Neo-Bank',
    description: 'Revolutionizing digital banking with a focus on fluid UX and airy interfaces.',
  ...
  },
  {
    ...
    title: 'Lunar Coffee',
    description: 'A cosmic identity for a specialty roastery reaching for the stars.',
  ...
  },
  {
    ...
    title: 'Eco-Pulse',
    description: 'Sustainable materials meet high-energy visual language for Gen-Z.',
    client: 'Vitality Co.',
  ...
  },
  {
    ...
    title: 'Sonic Brand',
    description: 'Translating sound into a vibrant visual language for digital platforms.',
    client: 'AudioWave',
  ...
  },
  {
    ...
    title: 'Urban Wear',
    description: 'Capturing the raw energy of street culture through a luxury lens.',
    client: 'Urbanist',
  ...
  },
  {
    ...
    title: 'Vibe Studio',
    description: 'Dynamic storytelling that moves audiences and drives engagement.',
        ...
        <div className="mx-auto max-w-[1280px] px-6 pb-32">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {filteredProjects.map((project, idx) => (
              <div 
                key={project.id} 
                className="project-card group relative overflow-hidden rounded-2xl bg-slate-50 cursor-pointer animate-fade-in-up opacity-0 [animation-fill-mode:forwards]"
              ...
              >
                ...
                <div className="overlay absolute inset-0 bg-white/95 p-10 flex flex-col justify-end opacity-0 transition-all duration-500">
                  <div className="mb-auto flex justify-between items-start">
                    <span className="text-[#0e5e8a] text-[10px] font-black uppercase tracking-[0.2em]">{project.subCategory}</span>
                    <a className="text-slate-400 hover:text-[#0e5e8a] transition-colors flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest" href="#">
                      <span className="material-symbols-outlined text-sm">link</span> Follow on Instagram
                    </a>
                  </div>
                  ...
                  <div className="flex items-center justify-between border-t border-slate-100 pt-6">
                    ...
                    <div className="flex items-center text-[#0e5e8a] font-bold text-xs uppercase tracking-widest gap-2 group/link">
                      Case Study <span className="material-symbols-outlined text-lg group-hover/link:translate-x-1 transition-transform">arrow_forward</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-[960px] px-6">
            <div className="flex flex-col items-center text-center gap-12">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                <button className="flex min-w-[200px] items-center justify-center rounded-full h-16 px-10 bg-[#0e5e8a] text-white text-xs font-bold uppercase tracking-widest hover:shadow-2xl hover:shadow-[#0e5e8a]/30 transition-all active:scale-95">
                  Get in Touch
                </button>
